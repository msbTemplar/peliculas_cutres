...
def home(request, year=datetime.now().year, month=datetime.now().strftime('%B')):
    ...
    return render(request, 'peliculas_cutres_app/home.html', context)
...
def login_user(request):
    ...
    if request.method == "POST":
        ...
        context = {}
        return render(request, 'peliculas_cutres_app/login.html', context)
...
def register_user(request):
    ...
    context={'form':form}
    return render(request, 'peliculas_cutres_app/register_user.html', context)
...
def lista_series_peliculas(request):
    ...
    return render(request, 'peliculas_cutres_app/toda_lalista_series_peliculas.html', context)
...
def actualizar_serie_pelicula(request, id_serie_pelicula):
    ...
    return render(request, 'peliculas_cutres_app/actualizar_serie_pelicula.html', context)
